...
def main():
    ...
    ax1 = plt.subplot(311)
    plt.plot(t, training_loss, label='training loss')
    plt.plot(t, validation_loss, label= 'validation loss')
    plt.ylabel('Loss')
    ...
    plt.plot(t, accuracy, label='validation_acc')
    plt.plot(t, taccuracy, label='training_acc')
    plt.ylabel('Accuracy')
    plt.legend()
    plt.setp(ax2.get_xticklabels(), visible=False)

    ax3 = plt.subplot(313, sharex=ax1)
    plt.plot(t, dice, label='validation_dice')
    plt.plot(t, tdice, label='training_dice')
    plt.legend()
    plt.ylabel('Dice')
