...
from transforms_whole import RandomCrop, RandomHorizontalFlip, RandomVerticalFlip, ToTensor, Compose, Sequential_Crop
...
class BeecellsDataset(Dataset):
    ...
    def __init__(self, img_num, input_path, mask_path):
        ...
        for i in range(img_num):
            ...
            img = np.array(Image.open(full_input_path).convert("RGB"), dtype=np.float32)[:, :, 0]/255
